    ...
    <div className="fixed inset-0 bg-black/80 backdrop-blur-xl flex items-center justify-center z-50 p-4">
      <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-3xl p-6 w-full max-w-6xl shadow-2xl border border-gray-700 relative overflow-hidden max-h-[95vh] transition-all duration-300">
        ...
        <form onSubmit={handleSubmit} className="relative">
          ...
          {/* Action Buttons */}
          <div className="flex justify-end gap-4 pt-6 mt-6 border-t border-gray-700 relative">
            <button
              type="button"
              onClick={handleClose}
            ...
            <button
              type="submit"
              className="px-8 py-3 rounded-xl bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-semibold shadow-lg hover:shadow-blue-500/30 transition-all duration-200 hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
              disabled={loading || uploadingImages}
            >
              {loading ? (
                <>
