...
const Sidebar = ({ isOpen, onClose }) => {
  const menuItems = [
    ...
    // { path: '/seller-products', icon: Package, label: 'Seller Products' },   // 👈 NEW
    // { path: '/commission', icon: Wallet, label: 'Commission' },                     // 👈 NEW
        ...
        <div className="p-6 border-b border-gray-700">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              /> */}
              <span className="text-xl font-semibold">Vistaraa</span>
            </div>
